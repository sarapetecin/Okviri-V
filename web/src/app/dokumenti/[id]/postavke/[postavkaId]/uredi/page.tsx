...
import { urediPostavko } from "./actions";
import { IskalniIzbirnik } from "../../nova/iskalni-izbirnik";

type UrediPostavkoPageProps = {
  params: Promise<{
    id: string;
    postavkaId: string;
  }>;
...
export default async function UrediPostavkoPage({
  params,
  searchParams,
}: UrediPostavkoPageProps) {
  ...
  const shraniPostavko = urediPostavko.bind(
    null,
    dokumentId,
    postavkaId,
  );

  const izbraniOkvirji = [...postavka.postavka_okvir]
  ...
  const imaPodokvir =
    postavka.postavka_podokvir?.je_podokvir ?? false;

  const izbranaDodatnaDela = new Set(
                ...
                <div className="grid gap-5 lg:grid-cols-2">
                  <div className="lg:col-span-2">
                    ...
                    <input
                      ...
                      name="opisSlike"
                      type="text"
                      defaultValue={postavka.opis_slike ?? ""}
                  ...
                  <div className="grid gap-5 sm:grid-cols-3 lg:col-span-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className={inputClassName}
                        defaultValue={postavka.kolicina}
                      />
                    </div>
                  </div>
                  ...
                  <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4 lg:col-span-2">
                    <input
                      ...
                      defaultChecked={postavka.ogledalo}
                    />
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              value={delo.id}
                              className="mt-0.5 h-4 w-4 rounded border-slate-300"
                              defaultChecked={izbranaDodatnaDela.has(delo.id)}
                            />
